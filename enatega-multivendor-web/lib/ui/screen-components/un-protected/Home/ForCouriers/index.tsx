...
const Couriers: React.FC = () => {
  ...
  return (
    <div className="my-[60px]" style={isArabic ? { direction: 'rtl', textAlign: 'right' } : {}}>
      <MoveableCard
        image={Banner2}
        ...
        middle={true}
      />
      <div className="grid grid-cols-1 md:grid-cols-2 my-[30px] gap-8">
        <MoveableCard
          image={competetiveEarning}
          heading={t('RidersInfoCards.heading2')}
          subText={t('RidersInfoCards.subHeading2')}
          button={EarningButton}
        />
        <MoveableCard
          image={flexibleHours}
          heading={t('RidersInfoCards.heading3')}
          subText={t('RidersInfoCards.subHeading3')}
          button={FLexiblegButton}
        />
      </div>

      <TinyTiles
        image="https://images.ctfassets.net/23u853certza/QScF4OasY8MBTmzrKJfv1/9afd4f8a826825cc097fb36606a81963/3DCourier.webp?w=200&q=90&fm=webp"
